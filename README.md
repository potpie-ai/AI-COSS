...
## Table of Contents
- [Data](#data)
- [Dev tools/SDLC](#dev-toolssdlc)
- [General Purpose](#general-purpose)
- [Horizontal Automation](#horizontal-automation)
- [Infrastructure](#infrastructure)
- [Productivity](#productivity)
- [Sales/GTM/Cx](#salesgtmcx)
- [Voice](#voice)
...
|------|--------|---------|-------------|
| Dust | [dust-tt/dust](https://github.com/dust-tt/dust) | [dust.tt](https://dust.tt/) | Custom AI agent to speed up work. Work automation, Build your team of AI agents: secure, connected to your data and customizable to your needs. Accelerate your entire organization with AI |
| Adala | [humansignal/Adala](https://github.com/humansignal/Adala) | [humansignal.github.io/Adala](https://humansignal.github.io/Adala/) | Autonomous agents specialized in data processing - Labeling data. Adala offers a robust framework for implementing agents specialized in data processing, with an emphasis on diverse data labeling tasks. |
| Wren | [canner/wrenai](https://github.com/canner/wrenai) | [getwren.ai](https://getwren.ai/) | Open-source GenBI AI Agent that empowers data-driven teams to chat with their data to generate Text-to-SQL, charts, spreadsheets, reports, and BI. |
| Bamboo AI | [pgalko/BambooAI](https://github.com/pgalko/BambooAI) | [github.com/pgalko/BambooAI](https://github.com/pgalko/BambooAI) | An open-source library that lets you analyze and explore data through natural language conversations using LLMs. Works with your local datasets or can fetch data from external sources and APIs. |

### Dev tools/SDLC

| Name | GitHub | Website | Description |
|------|--------|---------|-------------|
| Potpie AI | [potpie-ai/potpie](https://github.com/potpie-ai/potpie) | [potpie.ai](https://potpie.ai/) | Potpie is an open-source platform that creates AI agents specialized in your codebase, enabling automated code analysis, testing, and development tasks. |
| Botpress | [botpress/botpress](https://github.com/botpress/botpress) | [botpress.com](https://botpress.com/) | The open-source hub to build & deploy GPT/LLM Agents. Botpress is an all-in-one platform for building AI agents powered by the latest LLMs. |
| Keploy | [keploy/keploy](https://github.com/keploy/keploy) | [keploy.io](https://keploy.io/) | Unit and Integration Test generation for Developers. Generate tests and stubs for your codebase |
| Aider | [Aider-AI/aider](https://github.com/Aider-AI/aider) | [aider.chat](https://aider.chat/) | Aider lets you pair program with LLMs, to edit code in your local git repository. |
| Cline | [cline/cline](https://github.com/cline/cline) | [cline.bot](https://cline.bot/) | Autonomous coding agent right in your IDE, capable of creating/editing files, executing commands, using the browser, and more with your permission every step of the way. |
| Roo | [RooVetGit/Roo-Code](https://github.com/RooVetGit/Roo-Code) | [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline) | Roo Code (prev. Roo Cline) gives you a whole dev team of AI agents in your code editor. |
| All Hands | [All-Hands-AI/OpenHands](https://github.com/All-Hands-AI/OpenHands) | [all-hands.dev](https://www.all-hands.dev/) | OpenHands agents can do anything a human developer can: modify code, run commands, browse the web, call APIs, even copy code snippets from StackOverflow. |
| ReactAgent | [eylonmiz/react-agent](https://github.com/eylonmiz/react-agent) | [reactagent.io](https://reactagent.io/) | The open-source React.js Autonomous LLM Agent. Experimental autonomous agent that uses GPT-4 to generate and compose React components from user stories. |
| Refact | [smallcloudai](https://github.com/smallcloudai) | [refact.ai](https://refact.ai/) | Powerful AI coding assistant that combines completion, refactoring, chat, and more. Get work done faster with context-aware code completion, integrated in-IDE chat. |
| Codefuse | [codefuse-ai/codefuse-chatbot](https://github.com/codefuse-ai/codefuse-chatbot) | [github.com/codefuse-ai/codefuse-chatbot](https://github.com/codefuse-ai/codefuse-chatbot) | An intelligent assistant serving the entire software development lifecycle, powered by a Multi-Agent Framework, working with DevOps Toolkits, Code&Doc Repo RAG, etc. |
...
| Name | GitHub | Website | Description |
|------|--------|---------|-------------|
| CrewAI | [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | [crewai.com](https://www.crewai.com/) | Framework for orchestrating role-playing, autonomous AI agents. By fostering collaborative intelligence, CrewAI empowers agents to work together seamlessly. |
...
| Praison AI | [MervinPraison/PraisonAI](https://github.com/MervinPraison/PraisonAI) | [docs.praison.ai](https://docs.praison.ai/) | A production-ready Multi AI Agents framework, designed to create AI Agents to automate and solve problems ranging from simple tasks to complex challenges. |
